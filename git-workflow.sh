...
echo "- DOCKER_HUB_ACCESS_TOKEN: Personal Access Token with 'Read, Write, Delete' scopes"
echo ""
echo "📋 To create Docker Hub Access Token:"
echo "1. Go to https://hub.docker.com/settings/security"
echo "2. Click 'New Access Token'"
echo "3. Name: 'GitHub Actions CI/CD'"
echo "4. Permissions: 'Read, Write, Delete'"
echo "5. Copy the generated token and add it to GitHub Secrets"